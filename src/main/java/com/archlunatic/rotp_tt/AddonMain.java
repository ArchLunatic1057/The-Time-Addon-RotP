package com.archlunatic.rotp_tt;

import com.archlunatic.rotp_tt.init.InitSounds;
import com.archlunatic.rotp_tt.init.InitEntities;
...
public class AddonMain {
    ...
    public static final String MOD_ID = "rotp_tt";
